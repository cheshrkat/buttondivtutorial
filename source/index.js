(function () {
    ...
    // Because real buttons don't apply an outline for mouse clicks
    // we need to add in the input mode script and remove outlines.
    inputMode({
    ...
    // Mutationobserver to toggle tabindex when disabled
